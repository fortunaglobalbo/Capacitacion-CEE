    ...
    <div style={{ maxWidth: '880px', margin: '0 auto', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      {activeTab === 'formulario' && (
        <div>
          ...
          {/* PASO 1: AFICHE OFICIAL EN FORMATO 4:5 */}
          {currentStep === 1 && (
            <div style={{
              maxWidth: '480px',
              margin: '0 auto',
              ...
              {/* VISTA DEL AFICHE OFICIAL AJUSTADO A 4:5 */}
              {selectedCurso && (
                <div style={{
                  width: '100%',
                  background: '#ffffff',
      ...
      {showAficheModal && (
        ...
        >
          ...
          >
            <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px', color: '#ffffff' }}>
              <div>
